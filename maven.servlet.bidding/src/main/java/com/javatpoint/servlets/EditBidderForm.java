...
@WebServlet("/EditBidderForm")
public class EditBidderForm extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>");
		out.println("<head>");
		out.println("<title>Edit Bidder Form</title>");
		...
		BidderBean bean=BidderDao.viewById(id);
		
		out.print("<form action='EditBidder' method='post' style='width:300px'>");
		...
		out.print("</div>");
		out.print("<div class='form-group'>");
		out.print("<label for='postal1'>Postal</label>");
		out.print("<input type='password' class='form-control' value='"+bean.getPostal()+"'  name='postal' id='postal1' placeholder='Postal'/>");
		out.print("</div>  ");
		out.print("<div class='form-group'>");
